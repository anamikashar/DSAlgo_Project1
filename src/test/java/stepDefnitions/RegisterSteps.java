...
@When("The user clicks {string} button after entering the correct username,password,confirmed password")
public void the_user_clicks_button_after_entering_the_correct_username_password_confirmed_password(String string) {
